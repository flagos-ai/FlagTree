...
## 💫 NVIDIA TileIR [tileir](https://github.com/flagos-ai/FlagTree/tree/triton_v3.6.x/third_party/tileir/) (Triton 3.6)
...
Refer to [Tests of tileir3.6 backend](https://github.com/flagos-ai/FlagTree/blob/triton_v3.6.x/.github/workflows/tileir3.6-build-and-test.yml)
