...
FailureOr<KernelOp> getSingleVerifiedExecutableKernelFromModule(
...
FailureOr<SmallVector<Operation *>>
getCanonicalExecutableKernelBodyOps(KernelOp kernel,
...
getExecutableVectorMaskInfo(Operation *op, int64_t n,
                            llvm::StringRef consumer);
...
LogicalResult verifyExecutableCompactVectorBinaryOp(
    Operation *op, int64_t expectedN, llvm::StringRef consumer);

LogicalResult verifyExecutableCompactVectorStore(
...
LogicalResult expandExecutableCompactElementwise1DOp(
...
LogicalResult buildExecutableSoftmaxBody(
    OpBuilder &builder, Location loc, KernelOp kernel,
    const ExecutableSoftmaxBodyBuildSpec &spec, llvm::StringRef consumer);

LogicalResult buildExecutableSqrtBody(
    OpBuilder &builder, Location loc, KernelOp kernel,
...
LogicalResult buildExecutableReluBody(
    OpBuilder &builder, Location loc, KernelOp kernel,
    const ExecutableReluBodyBuildSpec &spec, llvm::StringRef consumer);

LogicalResult buildExecutableMaximumBody(
    OpBuilder &builder, Location loc, KernelOp kernel,
...
LogicalResult buildExecutableConvKxKBody(
    OpBuilder &builder, Location loc, KernelOp kernel,
...
LogicalResult verifyExecutableElementwise1DOpSequence(
    KernelOp kernel, ArrayRef<Operation *> ops, llvm::StringRef consumer);
...
getExecutableSoftmaxOpSequenceInfo(KernelOp kernel,
...
getExecutableConvKxKOpSequenceInfo(KernelOp kernel,
                                   ArrayRef<Operation *> ops,
                                   llvm::StringRef consumer);
