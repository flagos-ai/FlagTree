...
constexpr StringRef kGemmFailureReason =
    "did not match supported dot kernel";
constexpr StringRef kSoftmaxFailureReason =
    "did not match supported vector softmax";
constexpr StringRef kSqrtFailureReason =
    "did not match supported vector sqrt";
constexpr StringRef kReduceSumAllFailureReason =
    "did not match supported vector reduce_sum_all";
constexpr StringRef kReluFailureReason =
    "did not match supported vector relu";
