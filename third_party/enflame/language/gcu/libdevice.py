...
func_mapping = {
    ...
    "cosh": cosh, "cospi":cospi, "erf": erf, "exp10":exp10, "exp2":exp2,
    "exp":exp, "expm1":expm1, "floor":floor, "rcp_rd":rcp_rd, "rcp_rn":rcp_rn,
    "rcp_ru":rcp_ru, "rcp_rz":rcp_rz, "rsqrt_rn":rsqrt_rn, "sqrt_rd":sqrt_rd,
    "sqrt_rn":sqrt_rn, "sqrt_ru":sqrt_ru, "sqrt_rz":sqrt_rz, "j0":j0,
    "j1":j1, "lgamma":lgamma, "log10":log10, "log1p":log1p, "log2":log2,
    "log":log, "rint":rint, "round":round, "rsqrt":rsqrt, "sin":sin,
    "sinh":sinh, "sqrt": sqrt, "tan":tan, "tanh":tanh, "trunc": trunc,
    "y0":y0, "y1":y1,
    # unary half float
    "float2half_rn":float2half_rn,
    # unary int float
    "ilogb":ilogb, "signbit":signbit, "float_as_int":float_as_int, "int_as_float":int_as_float,
    ...
    # unary long long float
    "ffs":ffs, "llrint":llrint, "llround":llround, "float2ll_rd":float2ll_rd,
    "float2ll_rn":float2ll_rn, "float2ll_ru":float2ll_ru, "float2ll_rz":float2ll_rz,
    "float2ull_rd":float2ull_rd, "float2ull_rn":float2ull_rn, "float2ull_ru":float2ull_ru,
    "float2ull_rz":float2ull_rz, "ll2float_rd":ll2float_rd, "ll2float_rn":ll2float_rn,
    "ll2float_ru":ll2float_ru, "ll2float_rz":ll2float_rz, "ull2float_rd":ull2float_rd,
    "ull2float_rn":ull2float_rn, "ull2float_ru":ull2float_ru, "ull2float_rz":ull2float_rz,
    # binary
    "max":max, "min":min,
    # binary i32
    "mulhi":mulhi,
    ...
    # other
    "isinf": isinf, "isnan": isnan, "finitef": finitef,
    "logger": logger,
}
