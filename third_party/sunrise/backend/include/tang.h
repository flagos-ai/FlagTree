...
#ifdef __cplusplus
  TAmoduleSymbolHandle_s() : function(nullptr) {}

  explicit TAmoduleSymbolHandle_s(TAfunction func) : function(func) {}

  explicit TAmoduleSymbolHandle_s(TAvariable var) : variable(var) {}
#endif // __cplusplus
...
typedef struct ptProfileInfo_s {
  ...
  uint64_t
      l2cache[6]; //!< [1]Monitor Read Hit Counter               [Offset: 0x610]
  ...
  uint64_t l1p5cache[6]; //!< [1]Monitor Read Hit Counter               [Offset:
                         //!< 0x610] [2]Monitor Cacheable Read Request Counter
                         //!< [Offset: 0x608] [3]Monitor Read Request Counter
                         //!< [Offset: 0x600] [4]Monitor Cacheable Write Request
                         //!< Counter[Offset: 0x60c] [5]Monitor Write Request
                         //!< Counter          [Offset: 0x604] [6]Monitor Write
                         //!< Hit Counter              [Offset: 0x614]
  uint32_t clock;
 ...
 */
TAresult TA_API __taCtxQueryLimit(TAcontext context, TAlimit limit,
                                  size_t *pCurrent, size_t *pLimit);
...
TAresult TA_API taDeviceGetAttribute(int *value, taDeviceAttr attr,
                                     TAdevice dev);
 ...
 * @return int
 */
TAresult TA_API taDeviceMemGetInfo(TAdevice device, size_t *free,
                                   size_t *total);
...
TAresult TA_API taCtxGetFunction(TAcontext ctx, const void *hostFunc,
                                 TAfunction *phFunc);

TAresult TA_API taCtxRegisterFunction(TAcontext ctx, const void *hostFunc,
                                      TAfunction hFunc);

TAresult TA_API taCtxGetBuiltInFunction(TAcontext ctx, const char *funcName,
                                        TAfunction *phFunc);
...
TAresult TA_API taCtxGetVariable(TAcontext ctx, const void *hostVar,
                                 TAvariable *hVar);

TAresult TA_API taCtxRegisterVariable(TAcontext ctx, const void *hostVar,
                                      TAvariable hVar);
 ...
 * @return int
 **********************************************************/
TAresult TA_API taDevicePrimaryCtxGetState(TAdevice dev, unsigned int *flags,
                                           int *active);
...
TAresult TA_API taMemAlloc(TAdeviceptr *dptr, size_t size);
TAresult TA_API taMemAllocAsync(TAdeviceptr *dptr, size_t size,
                                TAstream stream);
TAresult TA_API taMemAllocAsync_ptsz(TAdeviceptr *dptr, size_t size,
                                     TAstream stream);
 ...
 * @sa taMemFreeHost
 ***********************************************************/
TAresult TA_API taMemHostAlloc(void **hptr, size_t sizeBytes,
                               unsigned int flags);
TAresult TA_API taMemHostGetDevicePointer(TAdeviceptr *pdptr, void *pHost,
                                          unsigned int flags);
 ...
 ***********************************************************/
TAresult TA_API taMemHostRegister(void *hptr, size_t sizeBytes,
                                  unsigned int flags);
 ...
 * ::TANG_ERROR_INVALID_VALUE
 */
TAresult TA_API taPointerGetAttribute(void *data, TApointer_attribute attr,
                                      TAdeviceptr ptr);
...
TAresult TA_API taMemsetAsync(TAdeviceptr dptr, int value, size_t size,
                              TAstream stream);
TAresult TA_API taMemsetAsync_ptsz(TAdeviceptr dptr, int value, size_t size,
                                   TAstream stream);
 ...
 * @return int
 ************************************************************/
TAresult TA_API taMemcpyH2H_ptds(void *dstHost, const void *srcHost,
                                 size_t size);
 ...
 * ::TANG_SUCCESS
 ************************************************************/
TAresult TA_API taMemcpyH2D(TAdeviceptr dstDevice, const void *srcHost,
                            size_t size);
 ...
 * @return int
 ************************************************************/
TAresult TA_API taMemcpyH2D_ptds(TAdeviceptr dstDevice, const void *srcHost,
                                 size_t size);
 ...
 * @return int
 *************************************************************/
TAresult TA_API taMemcpyD2H_ptds(void *dstHost, TAdeviceptr srcDevice,
                                 size_t size);
 ...
 *************************************************************/
TAresult TA_API taMemcpyD2D(TAdeviceptr dstDevice, TAdeviceptr srcDevice,
                            size_t size);
 ...
 * @return int
 *************************************************************/
TAresult TA_API taMemcpyD2D_ptds(TAdeviceptr dstDevice, TAdeviceptr srcDevice,
                                 size_t size);

TAresult TA_API taMemcpyH2HAsync(void *dstHost, const void *srcHost,
                                 size_t size, TAstream stream);

TAresult TA_API taMemcpyH2HAsync_ptsz(void *dstHost, const void *srcHost,
                                      size_t size, TAstream stream);

TAresult TA_API taMemcpyH2DAsync(TAdeviceptr dstDevice, const void *srcHost,
                                 size_t size, TAstream stream);

TAresult TA_API taMemcpyH2DAsync_ptsz(TAdeviceptr dstDevice,
                                      const void *srcHost, size_t size,
                                      TAstream stream);

TAresult TA_API taMemcpyD2HAsync(void *dstHost, TAdeviceptr srcDevice,
                                 size_t size, TAstream stream);

TAresult TA_API taMemcpyD2HAsync_ptsz(void *dstHost, TAdeviceptr srcDevice,
                                      size_t size, TAstream stream);

TAresult TA_API taMemcpyD2DAsync(TAdeviceptr dstDevice, TAdeviceptr srcDevice,
                                 size_t size, TAstream stream);

TAresult TA_API taMemcpyD2DAsync_ptsz(TAdeviceptr dstDevice,
                                      TAdeviceptr srcDevice, size_t size,
                                      TAstream stream);
...
TAresult TA_API taStreamC2Ctransfers(TAstream hStream, uint32_t *cmd,
                                     uint32_t cmd_count, uint64_t device_addr,
                                     uint32_t mem_size);

TAresult TA_API taDeviceGetP2PAttribute(int *value, tangDeviceP2PAttr attr,
                                        int srcDevice, int dstDevice);
TAresult TA_API taDeviceGetPeerPointer(int device, int port, void *peerAddr,
                                       void **accessAddr);
TAresult TA_API taDeviceCanAccessPeer(int *canAccessPeer, int device,
                                      int peerDevice);
...
TAresult TA_API taMemcpyPeer(void *dst, int dstDevice, const void *src,
                             int srcDevice, size_t count);

TAresult TA_API taMemcpyPeerAsync(void *dst, int dstDevice, const void *src,
                                  int srcDevice, size_t count, TAstream stream);

//!< @ingroup Memory between peers.
//!< Copy data by HDMA
//!< @{{{
TAresult TA_API taMemcpyPeer_v2(TAdeviceptr dst, TAdevice dstDevice,
                                TAdeviceptr src, TAdevice srcDevice,
                                size_t size);

TAresult TA_API taMemcpyPeer_v2_ptds(TAdeviceptr dst, TAdevice dstDevice,
                                     TAdeviceptr src, TAdevice srcDevice,
                                     size_t size);

TAresult TA_API taMemcpyPeerAsync_v2(TAdeviceptr dst, TAdevice dstDevice,
                                     TAdeviceptr src, TAdevice srcDevice,
                                     size_t size, TAstream hStream);

TAresult TA_API taMemcpyPeerAsync_v2_ptsz(TAdeviceptr dst, TAdevice dstDevice,
                                          TAdeviceptr src, TAdevice srcDevice,
                                          size_t size, TAstream hStream);

TAresult TA_API taMemcpyFromPeerAsync(TAdeviceptr dst, TAdeviceptr src,
                                      TAdevice srcDevice, size_t size,
                                      TAstream stream);

TAresult TA_API taMemcpyToPeerAsync(TAdeviceptr dst, TAdevice dstDevice,
                                    TAdeviceptr src, size_t size,
                                    TAstream stream);

TAresult TA_API taMemcpyFromPeerAsync_ptsz(TAdeviceptr dst, TAdeviceptr src,
                                           TAdevice srcDevice, size_t size,
                                           TAstream stream);

TAresult TA_API taMemcpyToPeerAsync_ptsz(TAdeviceptr dst, TAdevice dstDevice,
                                         TAdeviceptr src, size_t size,
                                         TAstream stream);
//!< }}}@

TAresult TA_API taStreamWaitEvent(TAstream hStream, TAevent hEvent,
                                  unsigned int flags);
TAresult TA_API taStreamWaitEvent_ptsz(TAstream hStream, TAevent hEvent,
                                       unsigned int flags);
...
TAresult TA_API taStreamBeginCapture(TAstream hStream,
...
TAresult TA_API taStreamGetCaptureInfo(TAstream hStream,
                                       ...
                                       unsigned long long *pId, TAgraph *pGraph,
                                       const TAgraphNode **deps,
                                       size_t *numDeps);
TAresult TA_API taStreamGetCaptureInfo_ptsz(
    TAstream hStream, TAstreamCaptureStatus *pStatus, unsigned long long *pId,
    TAgraph *pGraph, const TAgraphNode **deps, size_t *numDeps);
...
TAresult TA_API taGraphAddHostNode(TAgraphNode *phGraphNode, TAgraph hGraph,
                                   const TAgraphNode *dependencies,
                                   size_t numDependencies,
                                   const TANG_HOST_NODE_PARAMS *nodeParams);

TAresult TA_API taGraphAddKernelNode(TAgraphNode *phGraphNode, TAgraph hGraph,
                                     const TAgraphNode *dependencies,
                                     size_t numDependencies,
...
TAresult TA_API taEventRecordWithFlags(TAevent hEvent, TAstream hStream,
                                       unsigned int flags);
TAresult TA_API taEventRecordWithFlags_ptsz(TAevent hEvent, TAstream hStream,
                                            unsigned int flags);
TAresult TA_API taEventSynchronize(TAevent hEvent);
TAresult TA_API taEventElapsedTime(float *pMilliseconds, TAevent hStart,
                                   TAevent hEnd);
...
TAresult TA_API taModuleLoadData(TAmodule *phModule, const void *image,
                                 size_t size);
 ...
 */
TAresult TA_API taModuleSymbolTypeGetName(char const **name,
                                          TAmoduleSymbolType type);
...
TAresult TA_API taModuleGetFunction(TAfunction *hfunc, TAmodule hmod,
                                    const char *name);

TAresult TA_API taFuncGetAttribute(int *pi, TAfunction_attribute attr,
                                   TAfunction hfunc);
...
TAresult TA_API taFunctionGetInfo(
    TAfunction func, TAdeviceptr *address, size_t *lenArgs,
    size_t *thread_regfile_size, size_t *shared_regfile_base,
    size_t *shared_regfile_size, size_t *warp_regfile_size,
    size_t *local_memory_size, size_t *static_shared_mem_size,
    size_t *shared_memory_mirror, size_t *max_threads_per_block,
    size_t *max_dynamic_shared_mem_size_per_block, size_t *max_block_count);

TAresult TA_API taModuleGetVariable(TAvariable *hVar, TAmodule hMod,
                                    const char *varName);

TAresult TA_API taVariableGetInfo(TAvariable hVar, TAdeviceptr *address,
                                  size_t *size);

TAresult TA_API taVariableCopyFromDevice(TAvariable hVar, TAdeviceptr src,
                                         size_t size, size_t offset);

TAresult TA_API taVariableCopyFromDevice_ptds(TAvariable hVar, TAdeviceptr src,
                                              size_t size, size_t offset);

TAresult TA_API taVariableCopyFromDeviceAsync(TAvariable hVar, TAdeviceptr src,
                                              size_t size, size_t offset,
                                              TAstream stream);
...
TAresult TA_API taVariableCopyFromHost(TAvariable hVar, const void *src,
                                       size_t size, size_t offset);

TAresult TA_API taVariableCopyFromHost_ptds(TAvariable hVar, const void *src,
                                            size_t size, size_t offset);

TAresult TA_API taVariableCopyFromHostAsync(TAvariable hVar, const void *src,
                                            size_t size, size_t offset,
                                            TAstream stream);
...
TAresult TA_API taVariableCopyToDevice(TAdeviceptr dst, TAvariable hVar,
                                       size_t size, size_t offset);

TAresult TA_API taVariableCopyToDevice_ptds(TAdeviceptr dst, TAvariable hVar,
                                            size_t size, size_t offset);

TAresult TA_API taVariableCopyToDeviceAsync(TAdeviceptr dst, TAvariable hVar,
                                            size_t size, size_t offset,
                                            TAstream stream);

TAresult TA_API taVariableCopyToDeviceAsync_ptsz(TAdeviceptr dst,
                                                 TAvariable hVar, size_t size,
                                                 size_t offset,
                                                 TAstream stream);

TAresult TA_API taVariableCopyToHost(void *dst, TAvariable hVar, size_t size,
                                     size_t offset);

TAresult TA_API taVariableCopyToHost_ptds(void *dst, TAvariable hVar,
                                          size_t size, size_t offset);

TAresult TA_API taVariableCopyToHostAsync(void *dst, TAvariable hVar,
                                          size_t size, size_t offset,
                                          TAstream stream);

TAresult TA_API taVariableCopyToHostAsync_ptsz(void *dst, TAvariable hVar,
                                               size_t size, size_t offset,
                                               TAstream stream);
 ...
 * @sa TA_STREAM_LEGACY
 ********************************************************/
TAresult TA_API taLaunchFunction(TAfunction func, unsigned int gridX,
                                 unsigned int gridY, unsigned int gridZ,
                                 unsigned int blockX, unsigned int blockY,
                                 unsigned int blockZ,
                                 unsigned int sharedMemBytes, TAstream stream,
                                 void **funcParams, void **extra);

TAresult TA_API taLaunchFunction_ptsz(TAfunction func, unsigned int gridX,
                                      unsigned int gridY, unsigned int gridZ,
                                      unsigned int blockX, unsigned int blockY,
                                      unsigned int blockZ,
                                      unsigned int sharedMemBytes,
                                      TAstream stream, void **funcParams,
                                      void **extra);

TAresult TA_API taLaunchKernel(TAfunction func, unsigned int gridX,
                               unsigned int gridY, unsigned int gridZ,
                               unsigned int blockX, unsigned int blockY,
...
TAresult TA_API taLaunchKernel_ptsz(TAfunction func, unsigned int gridX,
                                    unsigned int gridY, unsigned int gridZ,
                                    unsigned int blockX, unsigned int blockY,
                                    unsigned int blockZ,
                                    unsigned int sharedMemBytes,
...
TAresult TA_API taLaunchHostFunc_ptsz(TAstream hStream, TAhostFn fn,
                                      void *userData);

typedef void (*TAstreamCallback)(TAstream hStream, TAresult status,
                                 void *userData);

//!< callback(hStream, status, userData);
TAresult TA_API taStreamAddCallback(TAstream hStream, TAstreamCallback callback,
...
TAresult TA_API taLaunchHostFuncProxy(TAstream stream, void *proxy,
                                      void *proxy_data, void *func,
                                      void *func_data);

TAresult TA_API taLaunchHostFuncProxy_ptsz(TAstream stream, void *proxy,
                                           void *proxy_data, void *func,
                                           void *func_data);

TAresult TA_API taOccupancyMaxActiveBlocksPerMultiprocessor(
    int *numBlocks, TAfunction func, int blockSize, size_t dynamicSMemSize);
...
/**
 * @brief Opens an interprocess communication memory handle exported from
 * another process and map it into the current context and returns a device
 * pointer.
 *
 * @param pdptr
 * @param handle
 ...
 * ::taIpcCloseMemHandle
 */
TAresult TA_API taIpcOpenMemHandle(TAdeviceptr *pdptr, TAipcMemHandle handle,
                                   unsigned int flags);
 ...
 * @return int
 */
TAresult TA_API taStreamEngineCollAssign(int devId, int collType,
                                         uint64_t devAddr, int size,
                                         TAstream stream);
