...
#define TANGRT_VERSION_GIT_SHA                                                 \
  "04137493 Merge branch 'ln/bugfix/taStreamIsCapturing' into 'master'"
...
#warning                                                                       \
    "the ptcc used is not compatible with the tang runtime library\nptcc less than 2.0.0 is required."
// #error "the ptcc used is not compatible with the tang runtime library\nptcc
// less than 2.0.0 is required." #    elif (TANGRT_TANGCC_VERSION_MAJOR >= 2) &&
// (__TANGC_MAJOR__ <= 1) #error "the ptcc used is not compatible with the tang
