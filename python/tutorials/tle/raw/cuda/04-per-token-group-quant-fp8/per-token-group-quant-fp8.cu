...
extern "C" __device__ void per_token_group_quant_8bit(
    __attribute__((address_space(1))) void *__restrict__ output_q,
    __attribute__((address_space(1))) float *__restrict__ output_s,
    __attribute__((address_space(1))) const float *__restrict__ input, 
