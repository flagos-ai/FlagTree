...
#
#     # Node 0
#     NNODES=2 NODE_RANK=0 MASTER_ADDR=9.2.0.7 NPROC_PER_NODE=4 \
#         bash python/tutorials/tle/08-inter-node-gemm-reduce-scatter.sh --M 2048 --N 4096 --K 16384 --dtype bf16
#     # Node 1
#     NNODES=2 NODE_RANK=1 MASTER_ADDR=9.2.0.7 NPROC_PER_NODE=4 \
#         bash python/tutorials/tle/08-inter-node-gemm-reduce-scatter.sh --M 2048 --N 4096 --K 16384 --dtype bf16
#
...
exec torchrun \
    ...
    "$script_dir/08-inter-node-gemm-reduce-scatter.py" "$@"
