...
def spec_standard_func(spec):
    standard_spec_api_list = spec.standard_ext_spec_api_list
    ...
    for spec_api_name in standard_spec_api_list:
        if hasattr(spec, spec_api_name):
            ...
            setattr(sys.modules[math_module_name], spec_api.__name__, spec_api)
