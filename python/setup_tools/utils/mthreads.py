...
def get_resources_url(resource_name):
    ...
    if arch == 'aarch64':
        ...
        return {
            ...
            "plugin":
            "https://baai-cp-web.ks3-cn-beijing.ksyuncs.com/trans/mthreadsTritonPlugin-cpython3.10-glibc2.35-glibcxx3.4.30-cxxabi1.3.13-ubuntu-x64_v0.4.1.tar.gz"
        }[resource_name]
...
def get_resources_hash(resource_name):
    arch = platform.machine()
    if arch == 'aarch64':
        return {'plugin': "1a31d294"}[resource_name]
    elif arch == 'x86_64':
        return {"plugin": "ca6bb403"}[resource_name]
