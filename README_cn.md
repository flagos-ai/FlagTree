...
* 2026/07/07 新增接入 NVIDIA [tileir](https://github.com/flagos-ai/FlagTree/tree/triton_v3.6.x/third_party/tileir/) 后端（对应 Triton 3.6），加入 CI/CD。
* 2026/07/03 [iluvatar](https://github.com/flagos-ai/FlagTree/tree/triton_v3.6.x/third_party/iluvatar/) 后端升级到 Triton 3.6，加入 CI/CD。
* 2026/07/02 [xpu](https://github.com/flagos-ai/FlagTree/tree/triton_v3.6.x/third_party/xpu/) 后端升级到 Triton 3.6，加入 CI/CD。
* 2026/06/30 [sunrise](https://github.com/flagos-ai/FlagTree/tree/triton_v3.6.x/third_party/sunrise/) 后端升级到 Triton 3.6，加入 CI/CD。
