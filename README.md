...
* 2026/07/07 Added the [tileir](https://github.com/flagos-ai/FlagTree/tree/triton_v3.6.x/third_party/tileir/) backend integration (based on Triton 3.6) and added CI/CD.
